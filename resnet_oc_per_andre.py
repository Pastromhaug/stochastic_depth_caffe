...
def make_net(stages, device):
    ...
    with open('/home/pas282/caffe2/caffe/examples/stochastic_depth_caffe/residual_train_per_andre.prototxt', 'w') as f:
        print(str(resnet('examples/cifar10/cifar10_train_leveldb_padding' + str(device), stages=stages, batch_size=128)), file=f)

    with open('/home/pas282/caffe2/caffe/examples/stochastic_depth_caffe/residual_test_per_andre.prototxt', 'w') as f:
